...
function Datepicker() {
	...
	//20230718 ALLEN : 假設日期格式已經是民國年格式，Ex: 112/07/18
	this.regional["zh-TW"] = { // Default regional settings
		closeText: "完成", // Display text for close link
		prevText: "上一頁", // Display text for previous month link
		nextText: "下一頁", // Display text for next month link
		...
		dateFormat: "R/mm/dd", // See format options on parseDate
		firstDay: 0, // The first day of the week, Sun = 0, Mon = 1, ...
		isRTL: false, // True if right-to-left language, false if left-to-right
		showMonthAfterYear: true, // True if the year select precedes month, false for month then year
		yearSuffix: "", // Additional text to append to the year in the month headers,
		selectMonthLabel: "選擇月份", // Invisible label for month selector
		selectYearLabel: "選擇年度", // Invisible label for year selector
		changeYear: true,
		changeMonth: true,
	};
...
$.extend( Datepicker.prototype, {
	...
	_setDateFromField: function( inst, noDefault ) {
		...
		try {
			//20230718 ALLEN : 假設日期格式已經是民國年格式，Ex: 112/07/18
			if (dateFormat.includes("R") && dates.length > 0) {
